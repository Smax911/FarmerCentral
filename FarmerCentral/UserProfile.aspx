<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserProfile.aspx.cs" Inherits="FarmerCentral.UserProfile" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox9" runat="server" placeholder="Old Paasword" TextMode="Password" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="imgs/tractor.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Products Info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
