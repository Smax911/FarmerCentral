<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="FarmerCentral.WebForm1" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="imgs/barn.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Bought Date" TextMode="Date"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
